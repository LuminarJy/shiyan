...
<<<<<<< HEAD
# 可变形空间注意力相关参数
parser.add_argument('--use_deformable', action='store_true', help='使用可变形空间注意力机制')
parser.add_argument('--use_adaptive_aggregation', action='store_true', help='使用自适应特征聚合替代平均池化')
=======
